    ...
    public class DoctorRegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string HighestQualification 
            {
                get
                {
                    return this.HighestQualifications.ToString();
                }
                set
                {
                    HighestQualifications = (HighestQualificationEnum)Enum.Parse(typeof(HighestQualificationEnum), value,true);
                }
            }
            
            public  HighestQualificationEnum HighestQualifications { get; set; }
        ...
        public List<SelectListItem> PracticeNumberItem { set; get; }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            var user = new ApplicationUser
            {
                ...
                PracticeNumber = SelectedPracticeId,
