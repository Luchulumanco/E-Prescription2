...
namespace E_Prescription2.Controllers
{
    public class ChronicConditionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ChronicId,ConditionId,UserId,Date")] ChronicCondition chronicCondition)
        {
            ...
            ViewData["ConditionId"] = new SelectList(_context.Conditions, "ConditionId", "ICD_10_CODE", chronicCondition.ConditionId);
            ViewData["ConditionIds"] = new SelectList(_context.Conditions, "ConditionId", "Diagnosis", chronicCondition.ConditionId);
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "FullName", chronicCondition.UserId);
            return View(chronicCondition);
        }
