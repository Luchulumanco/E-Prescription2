...
{
    public class DrugAllergiesController : Controller
    {
        private readonly ApplicationDbContext _context;

        public DrugAllergiesController(ApplicationDbContext context)
        {
            _context = context;
        }
